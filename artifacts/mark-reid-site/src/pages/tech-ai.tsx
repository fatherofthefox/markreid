      ...
      <div className="container mx-auto px-6 py-24 md:py-32">
        <div className="max-w-4xl mx-auto mb-20">
          ...
          <h2 className="text-4xl md:text-6xl font-serif font-bold mb-8 text-foreground leading-tight">
            Pragmatic intelligence for enterprise scale.
          </h2>
          <p className="text-xl text-muted-foreground leading-relaxed font-light">
            I view Artificial Intelligence not as a novelty, but as a new primitive for software architecture. Here is how I structure AI within enterprise constraints.
          </p>
        </div>
        ...
        <div className="mb-32">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h3 className="text-sm font-mono text-muted-foreground uppercase tracking-widest">Featured Artifact</h3>
            <div className="h-px bg-border flex-1"></div>
          </div>
